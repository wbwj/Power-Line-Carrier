...
#define Flash_Save_Passward_Addr 0x08040000   //从0x08000000----0x08040000中存放密码
#define Flash_Save_Amend_Parameter_Addr0 0x08046000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr1 0x0804C000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr2 0x08053000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr3 0x08059000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr4 0x0805F000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr5 0x08066000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr6 0x0806C000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr7 0x08073000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr8 0x08079000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr9 0x0807F000   //存放LED0的控制灯
#define Flash_Save_Amend_Parameter_Addr10 0x0807A000  //存放LED0的控制灯
...
u8 mode=0;          //模式选择
u16 response=300;   //点灯响应时间(ms)
u8 i=0;             //灯的指针
u16 amend_parameter[20];    //用于变量存取使用
u16 abc1[20];
OS_ERR err;         //系统指针
